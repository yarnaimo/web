...
export const appPalette = {
  music: { background: hsl(346, 87, 97)(), color: hsl(346, 97, 62)() },
  dev: { background: hsl(40, 97, 95)(), color: hsl(40, 97, 53)() },
  other: { background: hsl(169, 70, 95)(), color: hsl(169, 70, 53)() },

  twitter: { background: hsl(204, 81, 96)(), color: hsl(204, 88, 53)() },
  github: { background: hsl(0, 0, 96)(), color: hsl(0, 0, 10)() },
  qiita: { background: hsl(94, 65, 94)(), color: hsl(94, 100, 39)() },
